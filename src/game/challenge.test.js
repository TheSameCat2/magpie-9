...
import { CHALLENGE_TARGET, minChallengeSeconds } from '../config/rules.js'
import { createRng } from '../lib/rng.js'
import { formatTime, utcDay } from '../lib/time.js'
...
test('challenge courses still warm up with two centred bulkheads', () => {
  ...
  assert.ok(
    course.some((g) => g.type === 'sled'),
    'expected a sled somewhere in 40 gates',
  )
})
